// In frontend/components/Navbar.js

const Navbar = {
    template: `
        <nav class="navbar navbar-expand-lg navbar-light bg-light py-3 shadow-sm sticky-top">
            <div class="container">
                <router-link class="navbar-brand font-weight-bold" to="/">Foodle</router-link>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="navbar-nav">
                        <div v-if="!isAuthenticated" class="d-flex">
                            <button class="btn btn-outline-secondary mx-2" @click="$router.push('/restaurant/login')">For Business</button>
                            <button class="btn btn-outline-primary mx-2" @click="$router.push('/login')">Login</button>
    ...
    `,
    computed: {
        ...Vuex.mapGetters(['isAuthenticated', 'currentUser', 'userRoles', 'cartItemCount']), // <-- ADD cartItemCount
