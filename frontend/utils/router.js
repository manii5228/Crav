...
import CustomerFavoritesPage from '../pages/customer/CustomerFavoritesPage.js'; // <-- Path likely needed correction
...
import RestaurantMenuManagementPage from '../pages/restaurant/RestaurantMenuManagementPage.js'; // <-- Path likely needed correction
import RestaurantOrderQueuePage from '../pages/restaurant/RestaurantOrderQueuePage.js'; // <-- Path likely needed correction
import RestaurantProfileManagementPage from '../pages/restaurant/RestaurantProfileManagementPage.js';
import RestaurantPromotionsPage from '../pages/restaurant/RestaurantPromotionsPage.js'; // <-- Path likely needed correction
...
// Navigation Guard: This function runs before each route change.
router.beforeEach((to, from, next) => {
    ...
    if (requiresAuth && !isAuthenticated) {
        ...
        // check if they have the necessary role.
        ...
        if (hasRole) {
            ...
            // User does not have the required role, redirect to a safe page.
            alert("You are not authorized to view this page.");
            next('/'); // Redirect to the customer homepage
        }
    } else {
