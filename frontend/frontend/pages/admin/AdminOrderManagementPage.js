    ...
    methods: {
        async fetchOrders() {
            ...
            try {
                ...
                this.orders = await apiService.get(endpoint);
            } catch (err) {
        ...
        async initiateRefund(orderId) {
            if (confirm(`Are you sure you want to process a refund for order #${orderId}?`)) {
                try {
                    const data = await apiService.post(`/api/admin/orders/${orderId}/refund`);
                    alert(data.message);
                    this.fetchOrders();
                } catch (err) {
        ...
        async exportData() {
            ...
            try {
                // NOTE: This uses fetch directly because apiService is built for JSON,
                // and this endpoint returns an Excel file (blob).
